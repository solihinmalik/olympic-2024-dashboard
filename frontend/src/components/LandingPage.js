  ...
  return (
    <div className="relative flex items-center justify-center min-h-screen text-center bg-white overflow-hidden">
      ...
      <div className="z-10 space-y-4">
        ...
        <p className="text-lg text-gray-600">Dashboard by The Developer</p>
        <nav className="flex gap-6 justify-center text-gray-700 font-medium">
          ...
          <a href="/dashboard/medals" className="hover:underline">Country</a>
          <a href="/dashboard/sports" className="hover:underline">Historical</a>
        </nav>
      </div>
    </div>
  );
